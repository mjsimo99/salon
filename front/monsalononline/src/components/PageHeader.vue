<template>
  ...
  <nav class=" bg-white fixed-top w-full flex relative justify-between items-center mx-auto px-8 h-20">
    <div class="inline-flex">
      <a class="_o6689fn" href="/">
        <div class="hidden md:block">
         <img src="https://cdn.myshoptet.com/usr/obchod.salononline.cz/user/logos/logo-2.png" alt="logo mon salon online" class="w-40">
        </div>
